   ...
   <Heading title="Product Entry"/>
    <div className="flex flex-col justify-around w-full mx-auto">
      ...
      <div className="flex justify-between w-full">
            ...
            <input type="number" placeholder="Enter Profit" name="profit" value= {profit}  onChange={async (e)=>await setProfit(e.target.value)}className="border mx-auto mb-1 border-gray-400 p-2 w-full"  required />
           </div>
